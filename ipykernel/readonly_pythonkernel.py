...
class ReadOnlyKernel(Kernel):
    ...
    def __init__(self, **kwargs):
        super(ReadOnlyKernel, self).__init__(**kwargs)
    ...
    def start(self):
        ...
        super(ReadOnlyKernel, self).start()

    def set_parent(self, ident, parent):
        """Overridden from parent to tell the display hook and output streams
        about the parent message.
        """
        super(ReadOnlyKernel, self).set_parent(ident, parent)
    ...
    def init_metadata(self, parent):
        ...
        """
        md = super(ReadOnlyKernel, self).init_metadata(parent)
    ...
    def do_execute(self, code, silent, store_history=True,
        ...
        code = "raise Exception(\"Execution not allowed in Read only Kernel. Please change kernel to execute code\")"
